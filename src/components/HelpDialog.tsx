        ...
        <div className="space-y-6 text-slate-700">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
              ...
              Настройка ИИ (Если Gemini заблокирован)
            </h3>
            <p className="mb-2">
              В РФ доступ к Google Gemini может быть ограничен. Вы можете использовать альтернативные модели через настройки (шестеренка в углу).
            </p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>
